...
syn_map
syn_opt
write_hdl > alarm_netlist.v
write_sdc > alarm_constraints_1.sdc
#write_sdf -timescale ns -nonegchecks -recrem split -edges check_edge -setuphold split > delays.sdf

report_power > power_counter.rpt
report_area > area_counter.rpt
report_timing > timing_counter.rpt
report_gates > gate_counter.rpt
