...
#  Created on Sun Mar  1 16:40:03 2026                
#                                                     
#######################################################
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site gsclib090site -r 1 0.7 2.5 2.5 2.5 2.5
uiSetTool select
getIoFlowFlag
fit
...
addRing -nets {VDD VSS} -type core_rings -follow core -layer {top Metal9 bottom Metal9 left Metal8 right Metal8} -width {top 0.7 bottom 0.7 left 0.7 right 0.7} -spacing {top 0.4 bottom 0.4 left 0.4 right 0.4} -offset {top 0.5 bottom 0.5 left 0.5 right 0.5} -center 0 -threshold 0 -jog_distance 0 -snap_wire_center_to_grid None
set sprCreateIeRingOffset 1.0
set sprCreateIeRingThreshold 1.0
set sprCreateIeRingJogDistance 1.0
set sprCreateIeRingLayers {}
...
addStripe -nets {VDD VSS} -layer Metal9 -direction horizontal -width 0.7 -spacing 0.4 -number_of_sets 5 -start_from bottom -switch_layer_over_obs false -max_same_layer_jog_length 2 -padcore_ring_top_layer_limit Metal9 -padcore_ring_bottom_layer_limit Metal1 -block_ring_top_layer_limit Metal9 -block_ring_bottom_layer_limit Metal1 -use_wire_group 0 -snap_wire_center_to_grid None
setAddStripeMode -ignore_block_check false -break_at none -route_over_rows_only false -rows_without_stripes_only false -extend_to_closest_target none -stop_at_last_wire_for_area false -partial_set_thru_domain false -ignore_nondefault_domains false -trim_antenna_back_to_shape none -spacing_type edge_to_edge -spacing_from_block 0 -stripe_min_length stripe_width -stacked_via_top_layer Metal9 -stacked_via_bottom_layer Metal1 -via_using_exact_crossover_size false -split_vias false -orthogonal_only true -allow_jog { padcore_ring  block_ring } -skip_via_on_pin {  standardcell } -skip_via_on_wire_shape {  noshape   }
addStripe -nets {VDD VSS} -layer Metal8 -direction vertical -width 0.7 -spacing 0.4 -number_of_sets 5 -start_from left -switch_layer_over_obs false -max_same_layer_jog_length 2 -padcore_ring_top_layer_limit Metal9 -padcore_ring_bottom_layer_limit Metal1 -block_ring_top_layer_limit Metal9 -block_ring_bottom_layer_limit Metal1 -use_wire_group 0 -snap_wire_center_to_grid None
setAddStripeMode -ignore_block_check false -break_at none -route_over_rows_only false -rows_without_stripes_only false -extend_to_closest_target none -stop_at_last_wire_for_area false -partial_set_thru_domain false -ignore_nondefault_domains false -trim_antenna_back_to_shape none -spacing_type edge_to_edge -spacing_from_block 0 -stripe_min_length stripe_width -stacked_via_top_layer Metal9 -stacked_via_bottom_layer Metal1 -via_using_exact_crossover_size false -split_vias false -orthogonal_only true -allow_jog { padcore_ring  block_ring } -skip_via_on_pin {  standardcell } -skip_via_on_wire_shape {  noshape   }
addStripe -nets {VDD VSS} -layer Metal8 -direction vertical -width 0.7 -spacing 0.4 -number_of_sets 5 -start_from left -switch_layer_over_obs false -max_same_layer_jog_length 2 -padcore_ring_top_layer_limit Metal9 -padcore_ring_bottom_layer_limit Metal1 -block_ring_top_layer_limit Metal9 -block_ring_bottom_layer_limit Metal1 -use_wire_group 0 -snap_wire_center_to_grid None
...
place_design
saveDesign placement_before.enc
setPlaceMode -fp false
place_design
...
timeDesign -postCTS -hold -pathReports -slackReports -numPaths 50 -prefix alarm_clock_top_postCTS -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -hold -pathReports -slackReports -numPaths 100 -prefix alarm_clock_top_postCTS -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -hold -pathReports -slackReports -numPaths 100 -prefix alarm_clock_top_postCTS -outDir timingReports
getCTSMode -engine -quiet
setOptMode -fixCap true -fixTran true -fixFanoutLoad true
...
report_timing
floorPlan -core_util 65 -aspect_ratio 1
floorPlan -r 1 0.65
zoomBox -23.07750 -0.79650 93.01900 55.33200
zoomBox -11.88300 1.07800 86.79900 48.78700
zoomBox -36.24800 -3.00200 100.33750 63.03200
zoomBox -51.71300 -5.58250 108.97600 72.10500
fit
place_design
clock_opt_design
...
group_path -name in2reg_tmp.138570 -from {0x3a6 0x3a9} -to 0x3aa -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.138570 -from {0x3ad 0x3b0} -to 0x3b1 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.138570 -from 0x3b3 -to 0x3b4
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.138570 -from 0x3b7 -to 0x3b8
setPathGroupOptions reg2reg_tmp.138570 -effortLevel high
...
reset_path_group -name reg2out_tmp.138570
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.138570
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.138570
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.138570
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.138570 -from {0x3c1 0x3c4} -to 0x3c5 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.138570 -from {0x3c8 0x3cb} -to 0x3cc -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.138570 -from 0x3ce -to 0x3cf
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.138570 -from 0x3d2 -to 0x3d3
setPathGroupOptions reg2reg_tmp.138570 -effortLevel high
reset_path_group -name reg2out_tmp.138570
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.138570
